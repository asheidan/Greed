...
%Will the UI be done before the meeting on friday?
	...
	We are behind schedule and that's because the server is not yet completed. It is however very close to be completed so we don't think that this will jeopardize the completion date.
