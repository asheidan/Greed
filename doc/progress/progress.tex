...
\begin{document}
	...
	% GUI design / UML / Description
		...
		\begin{figure}[t]
			\centering
				...
				\fi
			\caption{Class diagram of project}
			\label{fig:uml}
		\end{figure}
	\section{Metrics}
	...
	\begin{tabular}{*{9}{l}}
	    \begin{rotate}{45}\textbf{Milestone}\end{rotate} &
		 \begin{rotate}{45}\textbf{BCW\footnotemark}\end{rotate} & 
		 \begin{rotate}{45}\textbf{ACWP\footnotemark}\end{rotate} &
		 \begin{rotate}{45}\textbf{Planned Completion Date}\end{rotate} &
		 \begin{rotate}{45}\textbf{Actual Completion Date}\end{rotate}  &
		 \begin{rotate}{45}\textbf{BCWP\footnotemark (2010-04-09)}\end{rotate} &
		 \begin{rotate}{45}\textbf{BCWS\footnotemark (2010-04-09)}\end{rotate} \\
	    \hline
