...
\begin{document}
	...
	% GUI design / UML / Description
		...
		A class diagram of the software can be seen in \figurename{} \ref{fig:uml} on \pagename{} \pageref{fig:uml}.
		
		The software is split into three main parts.
		\begin{itemize}
			\item A {\tt Server} which, with the help of dRuby, communicates with local and remote clients.
			\item Several different players which implements more or less intelligent computer players.
				\begin{itemize}
				...
				\end{itemize}
			\item A \emph{special} player (called {\tt UIPlayer} in \figurename{} \ref{fig:uml}) which displays a user interface and lets the user interact with the game.
		\end{itemize}
...
%Will the UI be done before the meeting on friday?
		...
		\hline
	\end{tabular}
	\footnotetext[1]{Budgeted Cost of Work, estimated(planned) effort of the tasks.}
	\footnotetext[2]{Actual Cost of Work Performed, actual effort of the tasks that have been completed by a specific time}
	\footnotetext[3]{Budgeted Cost of Work Performed, estimated effort of the tasks that have been completed by a specific time}
	\footnotetext[4]{Budgeted Cost of Work Scheduled, estimated effort of the tasks that were scheduled to be completed by a specific time}
	\vspace{2mm}
