...
\begin{document}
	...
	% GUI design / UML / Description
		...
		The user interface (seen in \figurename{} \ref{fig:gui} on \pagename{} \pageref{fig:gui}) is implemented in Ruby/Tk. It is a prototype and may change in the final release. 
